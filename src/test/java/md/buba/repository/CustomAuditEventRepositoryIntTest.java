package md.buba.repository;

import md.buba.DrVadimApp;
import md.buba.config.Constants;
import md.buba.config.audit.AuditEventConverter;
import md.buba.domain.PersistentAuditEvent;
...
import static md.buba.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
