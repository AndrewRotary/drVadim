package md.buba.web.rest;

import md.buba.config.Constants;
import md.buba.DrVadimApp;
import md.buba.domain.Authority;
import md.buba.domain.User;
import md.buba.repository.AuthorityRepository;
import md.buba.repository.UserRepository;
import md.buba.security.AuthoritiesConstants;
import md.buba.service.MailService;
import md.buba.service.dto.UserDTO;
import md.buba.web.rest.errors.ExceptionTranslator;
import md.buba.web.rest.vm.KeyAndPasswordVM;
import md.buba.web.rest.vm.ManagedUserVM;
import md.buba.service.UserService;
...
@SpringBootTest(classes = DrVadimApp.class)
